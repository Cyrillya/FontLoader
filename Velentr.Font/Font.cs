...
namespace Velentr.Font
{
    ...
    public abstract class Font : IEquatable<Font>, IDisposable
    {
        ...
        /// </summary>
        public Dictionary<char, Internal.Glyph> CharacterGlyphs = new Dictionary<char, Internal.Glyph>();

        /// <summary>
        /// The text cache
        /// </summary>
        public Cache<string, Text> TextCache = new Cache<string, Text>(Constants.Settings.MaxTextCacheSize);
        ...
        /// <summary>
        /// Gets font family name of the font.
        /// </summary>
        /// <value>
        ...
        /// <summary>
        /// Gets full name of the font. FullName = FontFamily + StyleName
        /// </summary>
        /// <value>
        /// The full name of the font.
        /// </value>
        public string FullName => FontFamily + " " + StyleName;
        ...
        /// <summary>
        /// Whether to use the minimal glyph texture size.
        /// </summary>
        public bool MinimalTextureSize { get; set; }
        ...
        public Text MakeText(StringBuilder text, int lineSpacing = 0)
        {
            return MakeText(text.ToString(), lineSpacing);
        }
        ...
        /// <param name="applyMarkdown">Whether to apply markdown commands or not. Defaults to false. If set to true, Color will be the default color.</param>
        /// <returns>A Text object representing the Glyphs we need to draw to the screen for the input string.</returns>
        public Text MakeText(string text, int lineSpacing = 0)
        {
            Text textResult;
        ...
        internal int GetKerning(Internal.Glyph left, Internal.Glyph right)
        {
        ...
        public Internal.Glyph GenerateGlyph(char character)
        {
            var cache = _glyphCaches.FirstOrDefault(c => !c.Full);
            if (cache == null)
            {
                cache = new GlyphCache(this, _manager, MinimalTextureSize);
        ...
        /// <returns></returns>
        internal bool TryGetGlyph(char character, out Internal.Glyph glyph) {
